...
class Elementskit_Widget_Mail_Chimp extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
            ...
            [
                'raw' => '<strong>' . __( 'Please note!', 'elementskit' ) . '</strong> ' . __( 'Please set API Key in ElementsKit Dashboard - User Data - MailChimp and Create Campaign..', 'elementskit' ),
		...
		$this->add_control(
			...
			[
				...
				'description' => __('Create a campaign in mailchimp account <a href="https://mailchimp.com/help/create-a-regular-email-campaign/#Create_a_campaign" target="_blank"> Create Campaign</a>', 'elementskit'),
			]
		);	
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit_form_control' => 'flex: 0 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
    ...
    protected function render_raw( ) {
		 ...
		 <div class="ekit-mail-chimp">
			<form method="post" class="ekit-mailChimpForm" data-listed="<?php echo $ekit_mail_chimp_select_listed_id;?>">
